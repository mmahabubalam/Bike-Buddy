...
public class Aprilia extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String hit = "https://mmahabub.000webhostapp.com/project/aprilia.php";
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(Aprilia.this);
    ...
    public void openActivity(int pos){
        ...
        Intent intent = new Intent(Aprilia.this,Details.class);
