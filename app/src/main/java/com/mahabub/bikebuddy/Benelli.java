...
public class Benelli extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_benelli);

        progressBar = findViewById(R.id.progressbar);
        listView = findViewById(R.id.list_view);
        String hit = "https://mmahabub.000webhostapp.com/project/benelli.php";
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(Benelli.this);
    ...
    public void openActivity(int pos){
        ...
        Intent intent = new Intent(Benelli.this,Details.class);
