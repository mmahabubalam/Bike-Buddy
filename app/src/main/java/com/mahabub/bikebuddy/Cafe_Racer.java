...
public class Cafe_Racer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cafe_racer);

        progressBar = findViewById(R.id.progressbar);
        listView = findViewById(R.id.list_view);
        String hit = "https://mmahabub.000webhostapp.com/project/caferacer.php";
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(Cafe_Racer.this);
    ...
    public void openActivity(int pos){
        ...
        Intent intent = new Intent(Cafe_Racer.this,Details.class);
