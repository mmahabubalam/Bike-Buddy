...
public class Commuter extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String hit = "https://mmahabub.000webhostapp.com/project/commuter.php";
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(Commuter.this);
    ...
    public void openActivity(int pos){
        ...
        Intent intent = new Intent(Commuter.this,Details.class);
