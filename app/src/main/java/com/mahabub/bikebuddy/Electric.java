...
public class Electric extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String hit = "https://mmahabub.000webhostapp.com/project/electric.php";
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(Electric.this);
    ...
    public void openActivity(int pos){
        ...
        Intent intent = new Intent(Electric.this,Details.class);
