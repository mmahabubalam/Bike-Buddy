...
public class FKM extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String hit = "https://mmahabub.000webhostapp.com/project/fkm.php";
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(FKM.this);
    ...
    public void openActivity(int pos){
        ...
        Intent intent = new Intent(FKM.this,Details.class);
