...
public class Gpx extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String hit = "https://mmahabub.000webhostapp.com/project/gpx.php";
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(Gpx.this);
    ...
    public void openActivity(int pos){
        ...
        Intent intent = new Intent(Gpx.this,Details.class);
