...
public class Hero extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String hit = "https://mmahabub.000webhostapp.com/project/hero.php";
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(Hero.this);
    ...
    public void openActivity(int pos){
        ...
        Intent intent = new Intent(Hero.this,Details.class);
