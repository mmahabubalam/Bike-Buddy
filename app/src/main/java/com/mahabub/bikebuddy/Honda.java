...
public class Honda extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String hit = "https://mmahabub.000webhostapp.com/project/honda.php";
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(Honda.this);
    ...
    public void openActivity(int pos){
        ...
        Intent intent = new Intent(Honda.this,Details.class);
