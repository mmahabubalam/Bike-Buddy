...
public class Hpower extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hpower);

        progressBar = findViewById(R.id.progressbar);
        listView = findViewById(R.id.list_view);
        String hit = "https://mmahabub.000webhostapp.com/project/hpower.php";
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(Hpower.this);
    ...
    public void openActivity(int pos){
        ...
        Intent intent = new Intent(Hpower.this,Details.class);
