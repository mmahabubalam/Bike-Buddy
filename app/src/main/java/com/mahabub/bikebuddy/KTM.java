...
public class KTM extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String hit = "https://mmahabub.000webhostapp.com/project/ktm.php";
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(KTM.this);
    ...
    public void openActivity(int pos){
        ...
        Intent intent = new Intent(KTM.this,Details.class);
