...
public class Lifan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String hit = "https://mmahabub.000webhostapp.com/project/lifan.php";
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(Lifan.this);
    ...
    public void openActivity(int pos){
        ...
        Intent intent = new Intent(Lifan.this,Details.class);
