...
public class Naked_Sports extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_naked_sports);

        progressBar = findViewById(R.id.progressbar);
        listView = findViewById(R.id.list_view);
        String hit = "https://mmahabub.000webhostapp.com/project/nsports.php";
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(Naked_Sports.this);
    ...
    public void openActivity(int pos){
        ...
        Intent intent = new Intent(Naked_Sports.this,Details.class);
