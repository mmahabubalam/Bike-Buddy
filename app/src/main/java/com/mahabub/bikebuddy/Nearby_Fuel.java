...
public class Nearby_Fuel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nearby_fuel);
        ...
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String hit = "https://mmahabub.000webhostapp.com/project/fuel.php?shop=" + fuel.getText().toString();
                Load_Data(hit);
            }
        });
    }
    ...
    public int Load_Data(String url){
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(Nearby_Fuel.this);
    ...
    public void openActivity(int pos){
        ...
        Intent intent = new Intent(Nearby_Fuel.this, Nearby_Details.class);
