...
public class Off_Road extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_off_road);

        progressBar = findViewById(R.id.progressbar);
        listView = findViewById(R.id.list_view);
        String hit = "https://mmahabub.000webhostapp.com/project/offroad.php";
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(Off_Road.this);
    ...
    public void openActivity(int pos){
        ...
        Intent intent = new Intent(Off_Road.this,Details.class);
