...
public class Roadmaster extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_roadmaster);

        progressBar = findViewById(R.id.progressbar);
        listView = findViewById(R.id.list_view);
        String hit = "https://mmahabub.000webhostapp.com/project/roadmaster.php";
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(Roadmaster.this);
    ...
    public void openActivity(int pos){
        ...
        Intent intent = new Intent(Roadmaster.this,Details.class);
