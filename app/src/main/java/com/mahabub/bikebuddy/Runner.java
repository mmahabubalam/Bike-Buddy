...
public class Runner extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String hit = "https://mmahabub.000webhostapp.com/project/runner.php";
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(Runner.this);
    ...
    public void openActivity(int pos){
        ...
        Intent intent = new Intent(Runner.this,Details.class);
