...
public class Scooter extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String hit = "https://mmahabub.000webhostapp.com/project/scooter.php";
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(Scooter.this);
    ...
    public void openActivity(int pos){
        ...
        Intent intent = new Intent(Scooter.this,Details.class);
