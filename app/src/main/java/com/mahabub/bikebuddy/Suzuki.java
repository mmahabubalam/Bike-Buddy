...
public class Suzuki extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String hit = "https://mmahabub.000webhostapp.com/project/suzuki.php";
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(Suzuki.this);
    ...
    public void openActivity(int pos){
        ...
        Intent intent = new Intent(Suzuki.this,Details.class);
