...
public class TVS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String hit = "https://mmahabub.000webhostapp.com/project/tvs.php";
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(TVS.this);
    ...
    public void openActivity(int pos){
        ...
        Intent intent = new Intent(TVS.this,Details.class);
