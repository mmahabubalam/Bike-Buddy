...
public class Taro extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String hit = "https://mmahabub.000webhostapp.com/project/taro.php";
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(Taro.this);
    ...
    public void openActivity(int pos){
        ...
        Intent intent = new Intent(Taro.this,Details.class);
