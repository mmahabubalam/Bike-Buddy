...
public class Zontes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zontes);

        progressBar = findViewById(R.id.progressbar);
        listView = findViewById(R.id.list_view);
        String hit = "https://mmahabub.000webhostapp.com/project/zontes.php";
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(Zontes.this);
    ...
    public void openActivity(int pos){
        ...
        Intent intent = new Intent(Zontes.this,Details.class);
